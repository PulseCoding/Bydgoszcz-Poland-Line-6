...
try {
  ...
  var secBottlerSorter = 0,
    secBottlerOrientator = 0,
    secFillerCapper = 0,
    secLabeller = 0,
    secShrinkwrapper = 0,
    secBottleSeparator = 0,
    secEOL = 0,
    secPrinter = 0,
    seccheckWeigher = 0;
  var secTapper = 0;
  var auxStateBottlerSorter = 0,
    auxStateBottlerOrientator = 0,
    auxStateFillerCapper = 0,
    auxStateLabeller = 0,
    auxStateShrinkwrapper = 0,
    auxStateBottleSeparator = 0,
    auxStateEOL = 0;
  var auxStatePrinter = 0,
    auxStatecheckWeigher = 0,
    auxStateTapper;
  var flagBottlerSorter = 0,
    flagBottlerOrientator = 0,
    flagFillerCapper = 0,
    flagLabeller = 0,
    flagShrinkwrapper = 0,
    flagBottleSeparator = 0,
    flagEOL = 0;
  var flagPrinter = 0,
    flagcheckWeigher = 0;
  var tempCountPrinter = 0,
    tempCountcheckWeigher = 0,
    tempCountTapper;
  var ctFillerCapper = 0,
  ...
  var ctLabeller = 0,
    ...
    flagPrintLabeller = 0;
  var speedFlag = 0,
    statePalletisation = 0;
  var publishConfig;
  var secPubNub = 5*60;
  var tempTimeLabeller = 0,
    tempTimeTapper = 0,
    tempTimeCheckweigher = 0,
    tempTimePrinter = 0,
    tempTimeEOL = 0,
    tempTimeFillerCapper = 0,
    tempTimeCounterCaps = 0
